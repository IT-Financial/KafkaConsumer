...
public class BankAccInterface implements Serializable {
	/**
	 * 
	 */
	...
	public String toString() {
		return "BankAccInterface [occur_branch=" + occur_branch + ", bank_code=" + bank_code + ", bank_acc_no="
				...
				+ check_emp + ", sources=" + sources + ", GetTime=" + GetTime + ", topic_par=" + topic_par
