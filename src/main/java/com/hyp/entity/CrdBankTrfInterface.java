...
public class CrdBankTrfInterface implements Serializable {
	/**
	 * 融资融券
	 */
	...
	public String toString() {
		return "CrdBankTrfInterface [source_type=" + source_type + ", request_type=" + request_type + ", bank_code="
				...
				+ spare4 + ", cert_type=" + cert_type + ", id_no=" + id_no + ", com_handle=" + com_handle
				+ ", trf_source=" + trf_source + ", GetTime=" + GetTime + ", topic_par=" + topic_par + ", par_offset="
				+ par_offset + ", payload_length=" + payload_length + "]";
	}
