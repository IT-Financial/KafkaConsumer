...
public class OptBankTrfInterface implements Serializable {
	/**
	 * 期货
	 */
	...
	private String ip;
	private String mac;
	private int    reversal_num;
	private String update_time;
	private String reversal_mode;
	...
	public int getReversal_num() {
		return reversal_num;
	}

	public void setReversal_num(int reversal_num) {
		this.reversal_num = reversal_num;
	}
	...
	public String getReversal_mode() {
		return reversal_mode;
	}

	public void setReversal_mode(String reversal_mode) {
		this.reversal_mode = reversal_mode;
	}
	...
	public String toString() {
		return "OptBankTrfInterface [source_type=" + source_type + ", request_type=" + request_type + ", bank_code="
				...
				+ r_date + ", trf_source=" + trf_source + ", user_id=" + user_id + ", user_data=" + user_data + ", ip="
				+ ip + ", mac=" + mac + ", reversal_num=" + reversal_num + ", update_time=" + update_time
				+ ", reversal_mode=" + reversal_mode + ", GetTime=" + GetTime + ", topic_par=" + topic_par
