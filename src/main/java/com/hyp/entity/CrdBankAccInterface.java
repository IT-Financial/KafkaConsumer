...
public class CrdBankAccInterface implements Serializable {
	/**
	 * 融资融券
	 */
	...
	public String toString() {
		return "CrdBankAccInterface [occur_branch=" + occur_branch + ", bank_code=" + bank_code + ", bank_acc_no="
				...
				+ ", spare3=" + spare3 + ", spare4=" + spare4 + ", com_handle=" + com_handle + ", GetTime=" + GetTime
